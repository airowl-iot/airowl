...
namespace
{
    ...
    void onWiFiEvent(WiFiEvent_t event)
    {
        ...
        case ARDUINO_EVENT_WIFI_STA_GOT_IP:
            Serial.printf("[HAL][WiFi] Connected! IP: %s\n",
        ...
        case ARDUINO_EVENT_WIFI_STA_START:
            Serial.println("[HAL][WiFi] Station started");
            break;

        case ARDUINO_EVENT_WIFI_STA_CONNECTED:
            Serial.println("[HAL][WiFi] Connected to AP");
            break;

        case ARDUINO_EVENT_WIFI_STA_LOST_IP:
            Serial.println("[HAL][WiFi] Lost IP");
            break;
...
String WiFi::generateApName(const char *baseName)
{
    ...
    return String(baseName ? baseName : "AIROWL") + "_" + String(deviceId).substring(6);
}
...
WiFi::Status WiFi::getStatus() { return currentStatus; }
